...
class LessonTest extends TestCase
{
    ...
    {
        $response = $this->getJson('/api/modules/fake_value/lessons', $this->defaultHeaders());
    ...
    {
        $response = $this->getJson('/api/lessons/fake_value');
    ...
    {
        $response = $this->getJson('/api/lessons/fake_value', $this->defaultHeaders());
