...
@section('title', "Alterar o Imagem do Usuário {$user->name}")

@section('content')
    <h1 class="w-full text-3xl text-black pb-6">
        Alterar o Imagem do Usuário {{ $user->name }}
    </h1>
    ...
    <div class="flex flex-wrap">
        <div class="w-full my-6 pr-0 lg:pr-2">
            <div class="leading-loose">
                ...
                <form class="p-10 bg-white rounded shadow-xl" action="{{ route('admin.users.update.image', $user->id) }}"
